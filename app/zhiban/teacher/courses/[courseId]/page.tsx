...
import { TeacherCourseWorkspace } from '@/components/zhiban/teacher-course-workspace';
...
export default async function TeacherCoursePage({
  ...
  if (!course) notFound();
  return <TeacherCourseWorkspace principalName={principal.displayName} course={course} />;
}
