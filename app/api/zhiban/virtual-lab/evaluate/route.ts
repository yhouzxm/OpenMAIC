...
const EvaluationRequestSchema = z.object({
  mode: z.literal('assessment_mentor').default('assessment_mentor'),
  assessment: z.custom<VirtualLabAssessment>((value) =>
    Boolean(
      value &&
      typeof value === 'object' &&
  ...
  trainingContext: z.custom<TrainingContext>((value) =>
    Boolean(
      value &&
      typeof value === 'object' &&
      (value as Partial<TrainingContext>).course &&
      (value as Partial<TrainingContext>).state,
    ),
  ),
});
